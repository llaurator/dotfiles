# Generated by Powerlevel10k configuration wizard on 2026-08-28 at 18:41 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context                 # hostname / user@hostname when relevant
  ...
  # Local normal: solo hostname.
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=7
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%m'

  # Sin icono extra: ya tenemos el icono del SO delante.
